...
def train_LSTM(X, y, model, inp_dim, weights, epochs=EPOCHS, batch_size=BATCH_SIZE):
    ...
    for train_index, test_index in cv_object.split(X):
        ...
        #print("Y Train shape before:",y_train.shape)
        y_train = y_train.reshape((len(y_train), 1))
        #print("Y Train shape after:",y_train.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tokenizer', choices=['glove', 'nltk','nm'], required=True)
